...
class maskapai
{
	static void Main()
	{
		string nama,nik,tanggal,waktu,kelas="",maskapai="",tujuan="",username,password,bayar;
		int total,kembalian,x;
		...
		for( ; ;)
		{
			...
			Console.WriteLine("Kode Transaksi Anda : "+ nama + maskapai + tujuan);
